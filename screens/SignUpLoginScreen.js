      ...
      <Modal animationType="fade"
       ...
       <View style={styles.modalContainer}>
         ...
         <KeyboardAvoidingView style={styles.KeyboardAvoidingView}> 
          ...
          <TextInput style={styles.formTextInput}
           placeholder ={"Last Name"} maxLength ={8}
          ...
          <TextInput style={styles.formTextInput} placeholder ={"Email"}
           keyboardType ={'email-address'} onChangeText={(text)=>{ this.setState({ emailId: text }) }} />
           ...
           <TextInput style={styles.formTextInput} placeholder ={"Confrim Password"}
            secureTextEntry = {true} onChangeText={(text)=>{ this.setState({ confirmPassword: text }) }} />
