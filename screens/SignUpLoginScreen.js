...
import { Alert, KeyboardAvoidingView, Modal, ScrollView, StyleSheet, Text,
...
userLogin = (emailId, password) => {
  firebase.auth().signInWithEmailAndPassword(emailId, password)
   .then(() => { return Alert.alert("Successfully Login") })
    ...
    return Alert.alert("Password does not match")
      ...
      firebase.auth().createUserWithEmailAndPassword(emailId, password)
        ...
        .catch(function (error) {
          ...
          return Alert.alert(errorMessage) });
        db.collection("Users").add({ firstName: this.state.firstName, lastName:
           this.state.lastName, address: this.state.address, mobileNo:
           this.state.mobileNo, username: this.state.emailId })
        }
}
  ...
  return ( 
    <Modal animationType="fade" transparent={true} visible={this.state.isModalVisible}>
      <View style={styles.modalContainer}>
        ...
        <TextInput style={styles.formTextInput} placeholder={"Confrim Password"} secureTextEntry={true}
           onChangeText={(text) => {
